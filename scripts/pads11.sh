...
# PADS11: Healthy versus Parkinson; OMD excluded, fixed subject split.
# Usage: CUDA_VISIBLE_DEVICES=0 bash scripts/pads11.sh
python -u main.py \
  --datasets wearable \
  ...
  --batch_size 4 \
  --random_seed 42 \
  --feature_cache_dir ./feature_cache/timemosaic_graph_seed42/pads11 \
  --result_dir ./results/timemosaic_graph_seed42/pads11 \
  "$@"
